<?php 
    ...
    'title' => __('My Cases: Mock Data', 'gdi-modularity-cases'),
    'fields' => array(
        0 => array(
            'key' => 'field_6405f870fcf37',
            'label' => __('Mock Cases', 'gdi-modularity-cases'),
            'name' => 'mock_cases',
            'type' => 'true_false',
            'instructions' => '',
            'required' => 0,
            ...
            'message' => '',
            'default_value' => 0,
            'ui_on_text' => __('Enabled', 'gdi-modularity-cases'),
            'ui_off_text' => __('Disabled', 'gdi-modularity-cases'),
            'ui' => 1,
        ),
        1 => array(
            'key' => 'field_6405f8e1fcf38',
            'label' => __('JSON Mock Data', 'gdi-modularity-cases'),
            'name' => 'json_mock_data',
            'type' => 'textarea',
